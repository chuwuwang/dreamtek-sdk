...
//================== PINPAD =======================
    /**
         * custom pinpad ui interface
         *
         * @param keyId       pin key id(0~254)
         * @param param       <BR>
         *                    <ul>
         *                          <li>isOnline(boolean) return pin block(default true)</li>
    	 ...
    	 * @since 4.0.0
         * */
    	Map initPinInputView(int keyId, in Bundle param, in List<PinKeyCoorInfo> pinKeyInfos);

        /**
         * @param keyId        pin key id(0~254)
         * @param pinBlockType <BR>
         *                     |---0x00 3DES format0<BR>
         *                     |---0x01 3DES format1<BR>
         *                     |---0x02 3DES format2<BR>
         *                     |---0x03 3DES format3<BR>
         *                     |---0x04 AES format4<BR>
         * @param keySystem    <BR>
         *                     |---0x01 MK_SK<BR>
         *                     |---0x02 DUKPT<BR>
         * @param mode         <BR>
         *                     |---0x01 ECB<BR>
         * @param extraParams  <BR>
         *                     <ul>
         *                     <li>dispersionType(byte) just for AES calculate<BR>
         *                         |---0-DES112<BR>
         *                         |---1-DES168<BR>
         *                         |---2-AES128(default)<BR>
         *                         |---3-AES192<BR>
         *                         |---4-AES256<BR>
         *                     </li>
         *                     <li>notifyPinLenError(boolean) - Notification password is not long enough(default false)</li>
         *                     <li>random(byte[]) - random number participation in pinblock calculation(default not set)</li>
         *                     </ul>
         * @param listener     callback
         */
    	void startPinpad(int keyId, int pinBlockType, int keySystem, int mode, in Bundle extraParams, SecurityPinInputListener listener);
...
//================== clean  =======================
    ...
    */
     ...
     * corresponding to {@link com.dreamtek.smartposdeviceservice.aidl.sde.DataFormat.FormatType.FORMAT_TYPE_BCD} and {@link com.dreamtek.smartposdeviceservice.aidl.sde.DataFormat.FormatType.FORMAT_TYPE_ASCII}.
     ...
     * @param data The data that needs to be configured, please refer to {@link com.dreamtek.smartposdeviceservice.aidl.sde.DataFormat.DataType} for the currently supported types.
     * @param format refer to {@link com.dreamtek.smartposdeviceservice.aidl.sde.DataFormat.FormatType}
     * @return success or not
     * @throws RemoteException
     */
	boolean configDataFormat(String data, byte format);

	 /**
     * get data format before encryption
     * @param dataType - pls refer to DataFormat.DataType which in com.dreamtek.smartposconstdefine.ConstISde
     * @return 0 - ASCII, 1 - BCD, other value means error.
     * @throws RemoteException
     */
    byte getDataFormat(String dataType);
}