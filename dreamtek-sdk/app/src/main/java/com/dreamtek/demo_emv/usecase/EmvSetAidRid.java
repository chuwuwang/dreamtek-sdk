package com.dreamtek.demo_emv.usecase;
...
import com.dreamtek.smartpos.deviceservice.constdefine.ConstIPBOC;

import com.dreamtek.demo_emv.basic.EMVParamKey;
import com.dreamtek.demo_emv.caseA.EMVParamAppCaseA;
import com.dreamtek.demo_emv.caseA.EMVParamKeyCaseA;
...
public class EmvSetAidRid {
    ...
    public void setAID( int type ){
        ...
        if( type == ConstIPBOC.updateRID.operation.clear ){
            ...
            isSuccess = false;
            try {
                isSuccess = iemv.updateGroupParam(2, 1, null ,new Bundle());
                Log.d("TAG", "Clear AID (smart AID):" + isSuccess);
                isSuccess = iemv.updateGroupParam(2 ,2, null ,new Bundle());
...
//                ""
        ...
        emvParamAppUMSList[1].append(EMVParamAppCaseA.TAG_CurrencyCodeTerm_5F2A	, "0156" );  // 	5F2A	02	0156
        ...
        emvParamAppUMSList[1].append(EMVParamAppCaseA.TAG_CountryCodeTerm_9F1A	, "0156" );  // 	9F1A	02	0156
...
//                isSuccess = iemv.updateAID(emvParamAppUMSList[i].flagAppendRemoveClear, emvParamAppUMSList[i].aidType, emvParamAppUMSList[i].getTlvString());
                isSuccess = iemv.updateGroupParam(emvParamAppUMSList[i].flagAppendRemoveClear, emvParamAppUMSList[i].aidType, emvParamAppUMSList[i].getTlvString(),new Bundle());
                Log.d("TAG", "" + isSuccess);
        ...
        for( int i = 0; i< 2; i++ ){
            for( String aid : aidList ) {
                ...
                try {
                    ...
                    isSuccess = iemv.updateGroupParam(emvParamAppUMS.getFlagAppendRemoveClear(), emvParamAppUMS.getAidType(), emvParamAppUMS.getTlvString(),new Bundle());
                } catch (RemoteException e) {
                    e.printStackTrace();
                }
                Log.d("TAG", "" + isSuccess);
    ...
    public void setRID(int type){
        ...
        if( type == 3 ){
            ...
            isSuccess = false;
            try {
                isSuccess = iemv.updateGroupParam(2, 3,null,new Bundle() );
        ...
        try {
            boolean bRet = iemv.updateGroupParam( emvParamKeyUMS.flagAppendRemoveClear,3, emvParamKeyUMS.getTlvString() ,new Bundle());
            if( bRet ) {
        ...
        for( String rid : ridList  ) {
            try {
                ...
                boolean bRet = iemv.updateGroupParam( ConstIPBOC.updateRID.operation.append, 3,emvParamKeyUMS.getTlvString() ,new Bundle());
                if( bRet ) {
