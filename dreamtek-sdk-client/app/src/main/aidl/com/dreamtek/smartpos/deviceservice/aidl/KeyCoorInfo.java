...
public class KeyCoorInfo implements Parcelable {
    ...
    protected KeyCoorInfo(Parcel in) {
    ...
    public static final Creator<KeyCoorInfo> CREATOR = new Creator<KeyCoorInfo>() {
        @Override
        public KeyCoorInfo createFromParcel(Parcel in) {
            return new KeyCoorInfo(in);
        }

        @Override
        public KeyCoorInfo[] newArray(int size) {
            return new KeyCoorInfo[size];
        }
    };
     ...
     */
    public KeyCoorInfo(String keyName, int coor1_x, int coor1_y, int coor2_x, int coor2_y, int keyType) {
        LogUtil.d("TAG", "keyname:" + keyName + " x1:" + coor1_x + " y1:" + coor1_y + " x2:" + coor2_x + " y2:" + coor2_y);
