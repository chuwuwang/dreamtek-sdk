...
//         please note: "numeric" is mcc & mnc. Mini only support SLOT1 and will set mcc & mnc automatically, so doesn't need to set numeric param.
//         infos.putString("numeric", "46002");
//         "SLOT"   // Add by Simon on version 1.6.0.3
//          SLOT: 1 or 2 for SIM card in slot 1 or 2.  Noted: Only support setAPN on SLOT 1. Not support on SLOT 2.
//          using the active slot as default if there is no SLOT setting & no "fixed_numeric" setting
//          infos.putString("SLOT", "1"); (noted: mini doesn't support this param now)
