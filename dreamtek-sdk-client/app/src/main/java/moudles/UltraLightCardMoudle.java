...
public class UltraLightCardMoudle {
    Context context;
    ...
    public UltraLightCardMoudle(Context context, UltraLightCardMoudle ultraLightCardMoudle) {
        this.context = context;
        logUtils = MyApplication.serviceMoudle.logUtils;
        this.iUltraLightCard = iUltraLightCard;
        addAllapi();
    }
    ...
    private void addAllapi() {
        try {
            Class aClass = Class.forName("moudles.UltraLightCardMoudle");
        ...
        public byte[] My01read(byte bAddress) {
            try {
                byte[] ret = iUltraLightCard.read(bAddress);
        ...
        try
            {
                int result = iUltraLightCard.write(bAddress, pData);
...
//                logUtils.addCaseLog("The pdata: " + res);
    ...
    public UltraLightCardMoudle(Context context, IUltraLightCard iUltraLightCard) {
        this.context = context;
        logUtils = MyApplication.serviceMoudle.logUtils;
        this.iUltraLightCard = iUltraLightCard;
        addAllapi();
