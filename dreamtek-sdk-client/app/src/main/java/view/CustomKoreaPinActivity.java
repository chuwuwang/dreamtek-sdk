...
public class CustomKoreaPinActivity extends AppCompatActivity {
/*
    private View v;
...
//        v = View.inflate(this, R.layout.activity_keyboard, null);
    ...
    private void injectEssentialKey() {
        byte[] mKey = "01234567890123456789012345678901".getBytes();
        try {
            iPinpad.loadMainKeyWithAlgorithmType(99, mKey, 0x86, null);
            byte[] dataKey = BCDDecode.str2Bcd("54FE292FA27B134C08DEFB4CFF1425C4B8C1F772D78C1356B16EDE1FDDA7F843");
            Bundle extend = new Bundle();
            extend.putBoolean("isCBCType", true);
            extend.putByteArray("initVec", null);
            iPinpad.loadWorkKeyEX(11, 99, 98, 0x83, dataKey, null, extend);
        } catch (RemoteException e) {
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        contentView.post(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    Map<String, String> keyMap = iPinpad.initPinInputCustomViewForKoreaMode(98, 99, param, pinKeys, pinInputListener);
                    ...
                    iPinpad.startPinInputCustomViewForKoreaMode();
                } catch (RemoteException e) {
                    e.printStackTrace();
                }
    ...
    public void exitKeyBoardOnUI() {
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                CustomKoreaPinActivity.this.finish();
            }
        });
        try {
