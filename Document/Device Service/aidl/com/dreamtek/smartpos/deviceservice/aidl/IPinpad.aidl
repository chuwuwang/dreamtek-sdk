...
interface IPinpad {
     ...
     * <li>pinFormatType(int) - default is format0, 0-format0, 1-format1, 2-format2, 3-format3, 4-format4(For AES)</li>
...
/**
     ...
     *
     * @keyId - pinkey id (the id is the loadSessionKey(pin) id);
     * @param - parameter
     * <ul>
     ...
     *     <li>displayKeyValue(byte[]) - custom the sequence key number of pinpad</li>
     *     <li>random(byte[]) - random number participation in pinblock calculation(default not set)</li>
     *     <li>pinFormatType(int) - default is format0, 0-format0(3DES), 1-format1(3DES), 2-format2(3DES), 3-format3(3DES), 4-format4(AES)</li>
     *     <li>dispersionType(byte) - just for AES calculate, 0-DES112, 1-DES168, 2-AES128(default), 3-AES192, 4-AES256</li>
     * </ul>
