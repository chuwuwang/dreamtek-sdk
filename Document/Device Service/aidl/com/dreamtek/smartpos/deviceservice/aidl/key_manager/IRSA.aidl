...
interface IRSA {
     ...
     * <ul>
     * <li>keyIndex(int) (0~9) index of saved RSA key pair</li>
     ...
     * @param params parameters (list)
     * <ul>
     * <li>keyIndex(int) (0~9) index of RSA key</li>
     ...
     * <li>isHashData(Boolean) true - payment application calculate hash (Note: android baseSDKLibrary max parameter length limit is 1Mbit) ;  false - this interface will calculate hash ;   default false</li>
     ...
     * @param params parameters (list)
     * <ul>
     * <li>keyIndex(int) (0~9) index of Certification RSA public key</li>
