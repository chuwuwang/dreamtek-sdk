...
interface SmartCardExSearchListener {
    ...
    /**
     *
     * @param cardType, refer the com/dreamtek/smartpos/deviceservice/constdefine/ConstISmartCardReaderEx.java, class ConstISmartCardReaderEx.CardType for defines
     * @since >= 2.0.9
